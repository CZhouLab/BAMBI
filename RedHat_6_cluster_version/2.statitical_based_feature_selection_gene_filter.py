...
folder_path = "/home/peng.zhou-umw/project/Biomarker_Detection/Biomarker_Detection_Paper/Compare_Datasets_20230328/GSE54456_PC_Whole_revised"

# standard_file_path = "/home/peng.zhou-umw/project/Biomarker_Detection/Biomarker_Detection_Paper/TCGA_Correct_Breast_Cancer_wilcox_New_FPKM/output/summary_step1.txt"


gene_type_list = ["protein_coding"] # protein_coding lincRNA microarray
...
# for partition in range(partition_num):
    ...
    # output_directory = folder_path + "/CV_partition_" + str(partition) + "/output"
output_directory = folder_list[i] + "/output"

# print("CV_partition_" + str(partition))
# output_dict["partitions"].append(partition)
...
for gene_type in gene_type_list:
    ...
    # print(i)
    # print(pvalue_type_list)
    # print(pvalue_threshold_list)
