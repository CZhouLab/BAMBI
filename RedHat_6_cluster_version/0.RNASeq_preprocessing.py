...
## path relative
directory = "/home/peng.zhou-umw/project/Biomarker_Detection/Biomarker_Detection_Paper/GSE89403_tuberculosis_validation_individual"
output_directory = directory + "/output"
...
pvalue_type_dict = {}
pvalue_type_dict["protein_coding"] = "pvalue"
pvalue_type_dict["lincRNA"] = "pvalue"
...
foldchange_threshold_dict["protein_coding"] = str(0.585)
foldchange_threshold_dict["lincRNA"] = str(0.585)
...
overlap_area_threshold_dict["protein_coding"] = 0.6
overlap_area_threshold_dict["lincRNA"] = 0.5
...
inputCSV = directory + "/input_info_GSE89403_individul_files.csv"
...
if from_FPKM_ReadCount_generation:
    ...
    if annotation_file == "gencode_v22":  ## ["gencode_v22", "gencode_v29", "gencode_v37", any path to gtf]
        Pipeline_step_2_1_para_3 = "/nl/umw_chan_zhou/Billy/annotation_file/gencode_v22/gencode_v22_ENSG_Type.txt"
    elif annotation_file == "gencode_v29":
        Pipeline_step_2_1_para_3 = "/nl/umw_chan_zhou/Billy/annotation_file/gencode_v29/gencode_v29_ENSG_Type.txt"
    elif annotation_file == "gencode_v37":
        Pipeline_step_2_1_para_3 = "/nl/umw_chan_zhou/Billy/annotation_file/gencode_v37/gencode_v37_ENSG_Type.txt"
    elif annotation_file == "LncBook_Version2.0_all":
        Pipeline_step_2_1_para_3 = "/nl/umw_chan_zhou/Billy/annotation_file/LncBook_Version2.0_all/LncBook_Version2.0_all_ENSG_Type.txt"
    else:
        Pipeline_step_2_1_1_tem = subprocess.Popen(['python', "/nl/umw_chan_zhou/Billy/annotation_file/ENSG_Type.py", annotation_file], stdout=subprocess.PIPE,)
    ...
    for gene_type in gene_type_list:
        ...
        if from_info_table_generation:
            ...
            for gene_name in dict_FPKM_0:
                ...
                flag_allZero_T = 0
                try:
                    y_C_kernel = NaiveKDE(kernel='gaussian', bw='ISJ').fit(np.array(tem_C_list))
                    y_C_sample = y_C_kernel.evaluate(generated_sample_x)
                except:
                    flag_allZero_C = 1
                try:
                    y_T_kernel = NaiveKDE(kernel='gaussian', bw='ISJ').fit(np.array(tem_T_list))
            ...
            info_df = info_df[
                ["pvalue", "padj", "abs(log2(fold-change))", "max_val", "mean_Control", "mean_Treatment",
