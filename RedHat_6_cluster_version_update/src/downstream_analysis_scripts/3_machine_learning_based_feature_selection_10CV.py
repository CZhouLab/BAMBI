...
def machine_learning_based_feature_selection_10CV(directory, biomarker_target_gene_type="protein_coding", dataset_name="Customized_Dataset"):
    ...
    for i in range(len(df)):
        ...
        run_Pipeline_tem = subprocess.Popen(['python', pipeline_path,
                                             '--input', Data_address,
                                             '--info_table', info_table,
                                             '--model', ' '.join(str(e) for e in model_list),
                                             '--metric', Model_Selection_Methods_Metric_trans,
                                             ...
                                             '--corrthreshold', High_Corr_Remove,
                                             ...
                                             '--Circ_padj', Circ_padj,
                                             '--Circ_FPKM', Circ_FPKM,
                                             '--pseudo_foldchange', pseudo_foldchange,
                                             '--pvalue_type', pvalue_type_list[current_partition],
                                             '--pvalue_threshold', pvalue_threshold_list[current_partition],
                                             '--foldchange_threshold', foldchange_threshold_list[current_partition],
                                             '--PC_maxmin_remove_threshold', PC_maxmin_remove_threshold,
                                             '--linc_maxmin_remove_threshold', linc_maxmin_remove_threshold,
                                             '--Circ_maxmin_remove_threshold', Circ_maxmin_remove_threshold,
                                             '--final_evaluation', "False",
                                             '--microarray_padj', microarray_padj,
                                             '--microarray_FPKM', microarray_FPKM,
