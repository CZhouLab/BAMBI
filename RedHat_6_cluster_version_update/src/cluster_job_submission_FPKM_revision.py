...
def pipeline_step_1(sample_name, R1_input, R2_input, unpaired_input, strandness, directory, Known_splice_site, GTF_file, ExonLength_file, sequence_type):
    ...
    HISAT2Index = directory + '/src/HISAT2_index/GRCh38_hg38/genome'
    ...
    sambamba_view_path = directory + "/src/sambamba_view.sh"
    sambamba_sort_path = directory + "/src/sambamba_sort.sh"
    sed_1_path = directory + "/src/sed_1.sh"
    sed_2_path = directory + "/src/sed_2.sh"
    sed_3_path = directory + "/src/sed_3.sh"
