...
def downstream_analysis(biomarker_target_gene_type="protein_coding", target_pvalue_type = "padj",
                        ...
                        dataset_name="Customized_Dataset", resubmit=False):
    directory = os.getcwd()
    ...
    run_Pipeline_tem = subprocess.Popen(['python', statitical_based_feature_selection_gene_filter_script_path,
                                         ...
                                         '--target_pvalue_threshold', target_pvalue_threshold,
                                         '--target_foldchange_threshold', target_foldchange_threshold,
                                         '--target_maxmin_remove_threshold', target_maxmin_remove_threshold,
                                         '--target_overlap_area_threshold', target_overlap_area_threshold])
...
def main():
    ...
    downstream_analysis(biomarker_target_gene_type=args.biomarker_target_gene_type,
                        ...
                        dataset_name=args.biomarker_target_gene_type, resubmit=False)
